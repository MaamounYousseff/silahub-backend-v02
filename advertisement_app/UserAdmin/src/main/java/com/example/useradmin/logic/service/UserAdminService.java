package com.example.useradmin.logic.service;

import com.example.useradmin.domain.mapper.UserMapper;
...
public class UserAdminService
{
    ...
    public Page<UserDto> getUserDtos(Pageable pageable)
    {
        ...
        List<UserDto> userDtos = UserMapper.fromUsers(page.getContent());
